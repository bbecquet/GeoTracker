      ...
      <fieldset>
        ...
        <ul className="padding-h-m">
          <li>
            <Setting
              title="Theme"
              desc="Light or dark color scheme"
          ...
          <li>
            ...
            <Setting
              title="Map tiles"
              desc="Background style for map views"
              className="padding-v-m"
            >
          ...
          <li>
            <Setting
              asLabel
              title="Use imperial system"
              desc="For distances and map scale"
              className="padding-v-m"
            >
              <CheckBox
                name="lengthUnit"
        ...
        <ul className="padding-h-m">
          <li>
            <Setting
              ...
              desc="Bad accuracy positions will be ignored"
              className="padding-v-m"
            >
              <div>
                <Length
          ...
          <li>
            <Setting
              asLabel
              title="Use fake GPS positions"
              desc="For easy indoor debugging"
              className="padding-v-m"
            >
              <CheckBox
                type="checkbox"
